...
#-------------------------------------
# Validate Policy with New Data Set
#-------------------------------------
...
# Use same control parameters
control <- list(alpha = 0.1, # low learning rate
                gamma = 0.5, # middle discount factor
                # epsilon only relevant when sampling
                # new experience based on existing policy
                epsilon = 0.1) # medium exploration factor

# set a seed for replicability
set.seed(1234)

# Sample new data with "epsilon-greedy" selection
data_new <- sampleExperience(N = 5000, # I recommend 5,000
                             env = RACE.env, 
                             states = states, 
                             actions = actions, 
...
# Look at first 250 records of data
data_new
...
# few typical examples of model-free
# and model-based approaches.

# Presented R model-free example 
# validating model and optimal policy
